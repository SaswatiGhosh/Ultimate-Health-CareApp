...
from backend.entity.artifact_entity import DataTransformationArtifact, DataIngestionArtifact,DataValidationArtifact
from backend.exception import MyException
from backend.logger import logging
from backend.utils.main_utils import save_object,save_numpy_array_data,read_yaml_file
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        try:
            ...
            save_object(self.data_tranformation_config.transformed_object_file_path, cluster_map)
