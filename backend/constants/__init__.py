...
MODEL_TRAINER_MIN_SAMPLES_SPLIT = [2,5,10]
MODEL_TRAINER_MIN_SAMPLES_LEAF  = [1,2,4]
MIN_SAMPLES_SPLIT_MAX_DEPTH = [None,5,10,20,30]
MIN_SAMPLES_SPLIT_CRITERION = ['entropy', 'gini']
